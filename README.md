...
recovers more evicted facts than compaction-supervised consolidation on all five synthetic
corpora (0.076 vs 0.017 mean; paired t(4)=3.10). On HotpotQA the arms do not separate. The same mask
